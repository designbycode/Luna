<template>
	<div class="nav">
		<div class="nav__wrapper felx">
			<div class="nav__brand mr-5">
			...
			<div class="nav__links__wrapper nav__links--right">
				<ul class="nav__links">
                    ...
                    <router-link  class="nav__links__item md-mr-3" tag="li" :to="{ name: 'cards'}"><a>Cards</a></router-link>
                    <router-link  class="nav__links__item" tag="li" :to="{ name: 'grid-component'}"><a>Grid Component</a></router-link>
				</ul>
			</div>
